...
import { Trophy, RefreshCw, Flame, BookOpen, User, FolderOpen, Clock, Rocket, Sparkles, Home, RefreshCw as RefreshCwIcon, Book } from "lucide-react";
...
export default function PC({
  ...
  // 标签页配置
  const tabs = [
    { key: 'update' as RankingType, label: '更新榜', icon: RefreshCw },
    { key: 'heat' as RankingType, label: '热度榜', icon: Flame },
    { key: 'words' as RankingType, label: '字数榜', icon: BookOpen }
  ];
          ...
          {books.length > 0 ? (
            ...
            <div className="p-12 text-center">
              <div className="w-16 h-16 bg-gray-200 dark:bg-gray-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <Trophy className="h-8 w-8 text-gray-400 dark:text-gray-400" />
              </div>
